...
import com.alihaydar.mathgame.databinding.ActivityMultipleBinding;

import java.util.Locale;
import java.util.Random;

public class MultipleActivity extends AppCompatActivity {
    private ActivityMultipleBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityMultipleBinding.inflate(getLayoutInflater());
        ...
        binding.buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userLife<=0){
                    ...
                    Intent intent=new Intent(MultipleActivity.this,ResultActivity.class);
